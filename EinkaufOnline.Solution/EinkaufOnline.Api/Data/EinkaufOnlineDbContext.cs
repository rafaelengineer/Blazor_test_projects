...
namespace EinkaufOnline.Api.Data
{
    public class EinkaufOnlineDbContext:DbContext
    {
        public EinkaufOnlineDbContext(DbContextOptions<EinkaufOnlineDbContext> options) : base(options) { }
